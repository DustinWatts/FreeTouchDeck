...
namespace FreeTouchDeck
{
  ...
  String handleFileList(String path)
  {
    ...
    File root = ftdfs->stopen(path,FILE_READ);
    path = String();
    int filecount = 0;
  ...
  String handleAPISList()
  {
    ...
    File root = ftdfs->stopen("/uploads",FILE_READ);
  ...
  String handleInfo()
  {
    ...
    // todo: support seamless file system
    ...
    webserver.on("/saveconfig", HTTP_POST, [](AsyncWebServerRequest *request)
                 {
                   if (request->hasParam("save", true))
                   {
                     ...
                     else if (savemode == "homescreen")
                     {
                       ...
                       ftdfs->remove("/config/homescreen.json");
                       File file = ftdfs->open("/config/homescreen.json", "w");
                       if (!file)
                       {
                         LOC_LOGD(module, "Failed to create file");
                         return;
                     ...
                     else if (savemode == "menu1")
                     {
                       ...
                       ftdfs->remove("/config/menu1.json");
                       File file = ftdfs->open("/config/menu1.json", "w");
                       if (!file)
                       {
                     ...
                     else if (savemode == "menu2")
                     {
                       ...
                       ftdfs->remove("/config/menu2.json");
                       File file = ftdfs->open("/config/menu2.json", "w");
                       if (!file)
                       {
                     ...
                     else if (savemode == "menu3")
                     {
                       ...
                       ftdfs->remove("/config/menu3.json");
                       File file = ftdfs->open("/config/menu3.json", "w");
                       if (!file)
                       {
                     ...
                     else if (savemode == "menu4")
                     {
                       ...
                       ftdfs->remove("/config/menu4.json");
                       File file = ftdfs->open("/config/menu4.json", "w");
                       if (!file)
                       {
                         LOC_LOGD(module, "Failed to create menu3.json");
                         return;
                     ...
                     else if (savemode == "menu5")
                     {
                       ...
                       ftdfs->remove("/config/menu5.json");
                       File file = ftdfs->open("/config/menu5.json", "w");
                       if (!file)
                       {
